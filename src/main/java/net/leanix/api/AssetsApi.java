...
public class AssetsApi {
    ...
    public void upsertAsset(String asset) throws ApiException {
        ...
        apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarAccept, localVarContentType, localVarAuthNames, null);
    }
}
